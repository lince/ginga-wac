...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-fbgrab --enable-static --enable-postproc --enable-pthreads --enable-shared"
...
#define CONFIG_FBGRAB 1
#define CONFIG_SHMGRAB 0
...
#define CONFIG_FB_GRAB_DEVICE_INDEV 1
#define CONFIG_SHM_GRAB_DEVICE_INDEV 0
