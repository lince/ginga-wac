...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-fbgrab --enable-static --enable-postproc --enable-pthreads --enable-shared
prefix=/usr/local
...
SRC_PATH="/usr/src/Lince/GingaCRC/FFMpeg"
SRC_PATH_BARE=/usr/src/Lince/GingaCRC/FFMpeg
BUILD_ROOT="/usr/src/Lince/GingaCRC/FFMpeg"
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -O3 -fno-math-errno -fno-tree-vectorize
ASFLAGS=   -g
CC_O=-o $@
...
CONFIG_FB_GRAB_DEVICE_INDEV=yes
