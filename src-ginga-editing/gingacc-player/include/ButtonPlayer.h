...
#ifndef BUTTONPLAYER_H_
#define BUTTONPLAYER_H_
...
namespace core {
namespace player {
	class ButtonPlayer : public Thread, public Player {
		protected:
			static ButtonPlayer* _instance;
		...
		public:
			static ButtonPlayer* getInstance();
