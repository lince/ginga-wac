...
namespace player {
	class Player : public IPlayer {
		private:
			...
			pthread_mutex_t addListM;
			pthread_mutex_t remListM;
			pthread_mutex_t referM;
			map<string, string>* properties;

			bool notifying;
			set<IPlayerListener*>* listeners;
			set<IPlayerListener*>* toAddListeners;
			set<IPlayerListener*>* toRemListeners;
		...
		public:
			...
			virtual bool setFocusHandler(bool isHandler);
