...
LuaPlayer::LuaPlayer (string mrl) : Player(mrl), Thread()
{
    ...
    this->surface = ((SurfaceCreator*)(
    		this->cm->getObject("Surface")))(NULL, 0, 0);

    this->surface->setCaps(this->surface->getCap("ALPHACHANNEL"));

	this->im = ((InputManagerCreator*)(this->cm->getObject("InputManager")))();
	this->im->addProceduralInputEventListener(this);
...
void LuaPlayer::stop ()
{
    ...
    {
	    this->im->removeProceduralInputEventListener(this);
...
bool LuaPlayer::setFocusHandler(bool isHandler) {
