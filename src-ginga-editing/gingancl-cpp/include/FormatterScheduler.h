...
#include "adapters/procedural/ProceduralPlayerAdapter.h"
...
//#endif
		...
		public:
			...
			FormatterLayout* getLayoutManager();
		...
		private:
			...
			void runActionOverProceduralObject(
...
//#if HAVE_WAC
			virtual void stopObject(IObjectMode* object);
