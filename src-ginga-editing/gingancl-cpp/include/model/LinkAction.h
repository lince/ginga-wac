...
#include "wac/editing/ModeManager.h"
#include "wac/editing/IMode.h"
#include "wac/editing/ILinkAction.h"
...
namespace model {
namespace link {
	class LinkAction : public Thread , public ILinkAction {
		protected:
			set<string> typeSet;
			//Modificações Caio
			int type;
