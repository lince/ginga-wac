...
#include "../../../include/PresentationEvent.h"
...
namespace event {
	...
	PresentationEvent::PresentationEvent(
		...
		wclog << "PresentationEvent::PresentationEvent ";
		...
		wclog << " begin = '" << begin << "' end = '" << end;
		wclog << " end - begin = '" << (end - begin) << endl;
	}
