...
http://www.telemidia.puc-rio.br
*******************************************************************************/
#include "../../../include/LinkAndCompoundTriggerCondition.h"
...
namespace link {
	...
	LinkAndCompoundTriggerCondition::~LinkAndCompoundTriggerCondition() {
		wclog << "LinkAndCompoundTriggerCondition::~LinkAndCompoundTriggerCondition" << endl;
	...
	void LinkAndCompoundTriggerCondition::addCondition(
		...
		if (condition->instanceOf("LinkTriggerCondition")) {
			...
			wclog << "LinkAndCompoundTriggerCondition::";
			wclog << "addCondition Warning! statements ";
			wclog << "trying to add a condition !instanceOf(LinkStatement)";
			wclog << " and !instanceOf(LinkTriggerCondition)";
			wclog << endl;
		}
	}
