...
#include "../../../include/LinkValueAssessment.h"
...
namespace link {
	LinkValueAssessment::LinkValueAssessment(string value) : LinkAssessment() {
		wclog << "LinkValueAssessment::LinkValueAssessment stringVal = '";
		wclog << value.c_str() << "'" << endl;
	...
	LinkValueAssessment::~LinkValueAssessment() {
		wclog << "LinkValueAssessment::~LinkValueAssessment" << endl;
	}
