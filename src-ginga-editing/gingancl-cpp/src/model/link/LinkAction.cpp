...
namespace link {
	...
	// Modificações Caio
	void LinkAction::setLinkType(int type) {
		this->type = type;
	}
	
	int LinkAction::getLinkType() {
		return type;
	}

	void LinkAction::setLinkId(string linkId) {
		this->linkId = linkId;
	}

	string LinkAction::getLinkId() {
		return linkId;
	}
	//Modificações Caio
	...
	IObjetcMode* LinkAction::getOjetcMode() {
