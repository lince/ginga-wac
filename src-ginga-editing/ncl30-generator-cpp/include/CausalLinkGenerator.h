...
*******************************************************************************/
/**
* @file CausalLinkGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _CAUSALLINKGENERATOR_H
#define	_CAUSALLINKGENERATOR_H
...
namespace ncl {
namespace generate {
    class CausalLinkGenerator : public CausalLink {
        public:
			 ...
			 */
             string generateCode(ConnectorBase* connectorBase);
    };
