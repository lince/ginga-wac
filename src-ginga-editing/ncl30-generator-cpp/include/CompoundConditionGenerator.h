...
/**
* @file CompoundConditionGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _COMPOUNDCONDITIONGENERATOR_H
#define	_COMPOUNDCONDITIONGENERATOR_H
...
namespace ncl {
namespace generate {
    class CompoundConditionGenerator : public CompoundCondition {
		public:
			/**
...
#endif	/* _COMPOUNDCONDITIONGENERATOR_H */
