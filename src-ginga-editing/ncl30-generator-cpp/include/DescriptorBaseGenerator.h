...
/**
* @file DescriptorBaseGenerator.h
* @author Caio Viel
* @date 29-01-10
*/


#ifndef _DESCRIPTORBASEGENERATOR_H
#define	_DESCRIPTORBASEGENERATOR_H
...
#include "DescriptorSwitchGenerator.h"
...
namespace ncl {
namespace generate {
    class DescriptorBaseGenerator : public DescriptorBase {
...
#endif //_DESCRIPTORBASEGENERATOR_H
