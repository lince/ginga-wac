...
/**
* @file DescriptorGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _DESCRIPTORGENERATOR_H
#define	_DESCRIPTORGENERATOR_H
...
namespace ncl {
namespace generate {
    class DescriptorGenerator : public Descriptor {
        public:
