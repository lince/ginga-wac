...
*******************************************************************************/
/**
* @file DescriptorSwitchGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _DESCRIPTOSWITCHRGENERATOR_H
#define	_DESCRIPTOSWITCHRGENERATOR_H
...
namespace ncl {
namespace generate {
    class DescriptorSwitchGenerator : public DescriptorSwitch {
        public:
			/**
...
#endif	/* _DESCRIPTOSWITCHRGENERATOR_H */
