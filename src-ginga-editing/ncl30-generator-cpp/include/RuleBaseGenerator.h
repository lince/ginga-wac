...
#ifndef _RULEBASEGENERATOR_H
#define	_RULEBASEGENERATOR_H
...
#include "CompositeRuleGenerator.h"
...
namespace ncl {
namespace generate {
    class RuleBaseGenerator : public RuleBase {
        public:
			/**
