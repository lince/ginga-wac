...
/**
* @file SimpleRuleGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _SIMPLERULEGENERATOR_H
#define	_SIMPLERULEGENERATOR_H
...
namespace ncl {
namespace generate {
    class SimpleRuleGenerator : public SimpleRule {
        public:
			/**
