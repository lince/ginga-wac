...
/**
* @file SwitchNodeGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _SWITCHNODEGENERATOR_H
#define	_SWITCHNODEGENERATOR_H
...
namespace ncl {
namespace generate {
    class SwitchNodeGenerator : public SwitchNode {
        public:
			/**
