...
/**
* @file TransitionBaseGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _TRANSITIONBASEGENERATOR_H
#define	_TRANSITIONBASEGENERATOR_H
...
namespace ncl {
namespace generate {
    class TransitionBaseGenerator : public TransitionBase {
         public:
			/**
...
#endif //_TRANSITIONBASEGENERATOR_H
