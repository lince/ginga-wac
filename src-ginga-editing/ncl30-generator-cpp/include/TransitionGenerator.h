...
/**
* @file TransitionGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _TRANSITIONGENERATOR_H
#define	_TRANSITIONGENERATOR_H
...
namespace ncl {
namespace generate {
    class TransitionGenerator : public Transition {
         public:
			/**
