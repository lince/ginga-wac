...
/**
* @file SimpleConditionGenerator.cpp
* @author Caio Viel
* @date 29-01-10
*/

#include "../include/SimpleConditionGenerator.h"
...
namespace generate {
    ...
    string SimpleConditionGenerator::generateCode() {
        string ret = "<simpleCondition role=\"" + this->getLabel() + "\" ";
        ret += "eventType=\"" + EventUtil::getTypeName(this->getEventType()) + "\" ";
        ret += "transition=\"" + EventUtil::getTransitionName(this->getTransition()) + "\" ";
        ...
        if (qualifier != SimpleCondition::NO_QUALIFIER) {
            ret+="qualifier=\"";
