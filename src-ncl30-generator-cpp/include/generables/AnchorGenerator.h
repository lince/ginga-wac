...
/**
* @file AnchorGenerator.h
* @author Caio Viel
* @date 29-01-10
*/

#ifndef _ANCHORGENERATOR_H
#define	_ANCHORGENERATOR_H

#include <ginga/ncl/interfaces/Anchor.h>
...
#include "LabeledAnchorGenerator.h"
...
namespace ncl {
namespace generator {
    class AnchorGenerator : public Anchor {
        public:
